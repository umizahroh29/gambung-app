...
<div class="container-fluid page">
  ...
  <div class="checkout-container">
    ...
    @if($detail->shipping_status != 'OPTCC')
    <div class="row">
    ...
    <div class="row">
      ...
      <div class="col-12">
        <p>Silahkan melakukan transaksi sesuai dengan waktu yang ditentukan,
          jika melebihi waktu maka akan dibatalkan oleh admin</p>
        </div>
      </div>
      <div class="row waktu text-center">
        <div class="col-12">
          <p>Sisa Waktu Bayar</p>
        </div>
        ...
        <div class="col-12 text-left">
          <form class="" action="{{ url('/upload-pembayaran') }}" method="post" enctype="multipart/form-data">
            @csrf
            <input type="text" name="code" value="{{ $transactions[0]->code }}" hidden>
            <p>Upload Bukti Bayar Disini : </p>
