                        ...
                        <table class="table table-striped" id="list">
                            ...
                            @foreach($produk as $pr)
                                <tr>
                                    ...
                                    <td>
                                        <form action="/mengelola-produk/delete" method="post">
                                            @csrf
...
@section('add-modal')
    <form action="/mengelola-produk/tambah" method="post" enctype="multipart/form-data">
        @csrf
    ...
    <form action="/mengelola-produk/add-images" enctype="multipart/form-data"
    ...
    <form action="/mengelola-produk/edit" method="post">
        @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row color-element d-none">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text"
                                               class="form-control @error('warna') is-invalid @enderror"
                                               name="warna" id="warna" value="{{ old('warna') }}">
                                        @error('warna')
                                        <span class="invalid-feedback">
                                                <strong>{{ $message }}</strong>
                                            </span>
...
@push('script')
    ...
    <script type="text/javascript">
                ...
                success: function (data) {
                    ...
                    $(data).each(function (i) {
                        ...
                        newRow = newRow.concat('<td>' +
                            '<form action="{{ url('/mengelola-produk/delete') }}" method="post">' +
        ...
        function getEditData(id) {
            $.ajax({
                url: "mengelola-produk/get-edit-data",
                method: "POST",
                data: {
                    id: id,
                },
                    ...
                    if (result['images'].length > 0) {
                        ...
                        for (var i = 0; i < result['images'].length; i++) {
                            if (result['images'][i]['main_image'] == 'OPTNO') {
                                $("#mainImage").after('<form action="/mengelola-produk/delete-images" method="post" class="deleteClass">@csrf<button name="id" type="submit" value="' + result['images'][i]['id'] + '" class="btn gallery-item"><img src="assets/img/products/' + result['images'][i]['image_name'] + '" width="100%" height="100%"></button></form>');
                            }
                        }
                    }
