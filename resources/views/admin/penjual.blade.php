...
@section('page', 'Manajemen Penjual')
                    ...
                    <div class="card-header-action">
                        <div class="input-group">
                            <button type="button" class="btn btn-primary btn-tambah" data-toggle="modal"
                                    data-target="#modal-tambah" onclick="resetModal()"><i class="fas fa-plus"></i> Tambah
                                Penjual
                            </button>
                        ...
                        <table class="table table-striped" id="list">
                            ...
                            @foreach($penjual as $pen)
                                <tr>
                                    ...
                                    <td>{{ $pen->email }}</td>
                                    <td>
                                        <form action="{{ url('/manajemen-penjual/delete') }}" method="post">
                                            @csrf
                                            <input type="hidden" name="id" value="{{ $pen->id }}">
                                            <button type="button" class="btn btn-outline-primary" data-toggle="modal"
                                                    data-target="#modal-edit" data-id="{{ $pen->id }}" name="edit">Edit
                                            </button>
...
@section('add-modal')
    <form action="/manajemen-penjual/tambah" method="post">
        @csrf
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4 col-4">
                                        ...
                                        <input type="text" name="nama_penjual" value="{{ old('nama_penjual') }}"
    ...
    <form action="/manajemen-penjual/edit" method="post">
        @csrf
...
@push('script')
    ...
    <script type="text/javascript">
        ...
        function getEditData(id) {
            ...
            $.ajax({
                url: "manajemen-penjual/get-edit-data",
                method: "POST",
                data: {
                    id: id,
                },
                success: function (result) {
                    $("input[name='nama_penjual']").val(result[0]['name']);
